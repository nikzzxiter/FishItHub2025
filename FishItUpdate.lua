...
print("Loading NIKZZ FISH IT - V2 UPGRADED...")
...
local Window = Rayfield:CreateWindow({
    Name = "NIKZZ FISH IT - V2 UPGRADED",
...
local function StartAutoJump()
    task.spawn(function()
        while Config.AutoJump do
            if Humanoid and Humanoid.Health > 0 and Humanoid:GetState() ~= Enum.HumanoidStateType.Jumping and Humanoid:GetState() ~= Enum.HumanoidStateType.Freefall then
                Humanoid.Jump = true
            end
...
local function Enable8Bit()
    -- 5x smoother/flatter 8-bit effect
    for _, obj in pairs(Workspace:GetDescendants()) do
...
local function CreateUI()
    ...
    Tab9:CreateParagraph({
        Title = "NIKZZ FISH IT - V2 UPGRADED",
    ...
    Tab9:CreateButton({
        ...
        Callback = function()
            ...
            print("=======================================")
            print("  NIKZZ FISH IT - V2 UPGRADED CLOSED")
    ...
    print("=======================================")
    print("  NIKZZ FISH IT - V2 UPGRADED LOADED")
...
-- Main Execution
print("Initializing NIKZZ FISH IT - V2 UPGRADED...")
...
if not success then
    ...
    print("NIKZZ FISH IT - V2 UPGRADED LOADED SUCCESSFULLY")
